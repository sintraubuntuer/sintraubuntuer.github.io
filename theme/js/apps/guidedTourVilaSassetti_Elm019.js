...
var author$project$OurStory$Narrative$endScreenInfo = {b_: 'Congratulations !!! ', b$: 'Now go look for that cache  :)', cb: '....\n                        ', bf: 'finalImage.png'};
...
var author$project$OurStory$Narrative$encriptedMsg = function (lgId) {
	...
	return (lgId === 'pt') ? ('KPPUYGOVXBW : ' + (encCoords + author$project$OurStory$Narrative$hintPT)) : ('KPPUYGOVXBW : ' + (encCoords + author$project$OurStory$Narrative$hintEn));
};
